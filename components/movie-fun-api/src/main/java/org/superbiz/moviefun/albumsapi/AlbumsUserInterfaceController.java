...
public class AlbumsUserInterfaceController {
...
//    private final BlobStore blobStore;
    ...
    public AlbumsUserInterfaceController(AlbumsServiceRestClient albumsServiceRestClient, String blobstoreUrl) {
    ...
    public String index(Map<String, Object> model) {
        ...
        model.put("blobstoreUrl", blobstoreUrl);
        return "albums";
    }

    @GetMapping("/{albumId}")
    public String details(@PathVariable long albumId, Map<String, Object> model) {
        model.put("album", albumsServiceRestClient.find(albumId));
        model.put("blobstoreUrl", blobstoreUrl);
        return "albumDetails";
    }
