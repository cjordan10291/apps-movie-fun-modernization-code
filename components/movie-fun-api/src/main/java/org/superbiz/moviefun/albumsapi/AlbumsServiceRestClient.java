...
public class AlbumsServiceRestClient {

    private final String albumsUrl;
    private final RestOperations restOperations;

    public AlbumsServiceRestClient(String albumsUrl, RestOperations restOperations) {
    ...
    public List<AlbumInfo> getAlbums() {
        ResponseEntity<List<AlbumInfo>> albumResponse =
                restOperations.exchange(albumsUrl,
